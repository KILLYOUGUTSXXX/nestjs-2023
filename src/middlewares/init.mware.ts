...
function assignInformationRequest (req: Request, currentValidation: TCombineOptValidate) {
...
export default class implements NestMiddleware {
  constructor (
    private validationConfig: ValidationRoute,
  ) {}
  use(req: Request, res: Response, next: NextFunction) {
    assignInformationRequest(req, this.validationConfig.verifyRoutes(req))
