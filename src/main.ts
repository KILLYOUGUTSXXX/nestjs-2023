...
async function bootstrap() {
  ...
  app.use(
    morgan((tokens, req: Request, res) => { 
      ...
      return (
        `\n\x1b[${methodColors[method] || 37}m\x1b[1m[${method}] ${pathUrl} :\x1b[0m\x1b[37m` +
        `\n\x1b[${methodColors[method] || 37}m\x1b[1m|-\x1b[0m ID              : ${reqID}` +
        `\n\x1b[${methodColors[method] || 37}m\x1b[1m|-\x1b[0m Resp. Status    : ${resStatus}` +
        `\n\x1b[${methodColors[method] || 37}m\x1b[1m|-\x1b[0m Uptime          : ${responseTime} sec` +
        `\n\x1b[${methodColors[method] || 37}m\x1b[1m|-\x1b[0m Date            : ${reqAt}` +
        `\n\x1b[${methodColors[method] || 37}m\x1b[1m|-\x1b[0m Logging         : ${logging}` +
        `\n\x1b[${methodColors[method] || 37}m\x1b[1m|-\x1b[0m Auth            : ${auths}`
      )
    })
  )
